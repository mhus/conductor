...
public class GitVersionValue  implements ValuePlugin {

    private static String version;
    
    @Override
    public String getValue(Context context, String value, IValuesProvider attributes) throws Exception {
        initGitVersion(context);
        return version;
    }

    private synchronized void initGitVersion(Context context) throws NotFoundException, IOException, MojoException {

...
@AOption(alias = {"-noco","-noconcatenate"})
public class MainOptionNoConcatenate implements MainOptionHandler {

    @Override
    public void execute(Cli cli, String cmd, LinkedList<String> queue) {
        ((MainCli) cli).getOverlayProperties().setBoolean(ConUtil.PROPERTY_CONCATENATE, false);
    }
    ...
    public String getDescription(String cmd) {
        return "Disable concatenation of lifecycles (parser will ignore arguments - and --";
    }
